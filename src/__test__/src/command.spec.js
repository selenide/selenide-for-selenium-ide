...
import Command from '../../code-export/command';
import {Commands as _Commands} from '@seleniumhq/side-model';
import {opts} from '../../code-export/index';
...
describe('command code emitter', () => {
  it.skip('should emit all known commands', () => {
    let result = [];
    Array.from(new Map(_Commands).keys()).array.forEach(command => {
